...
for filename in glob.glob(os.path.join('../input/training/essays', '*.txt')):
    print(count)
    count +=1
    f_name = (filename.split("../input/training/essays/"))[1]
    essay_name = (filename.split("../input/training/essays/"))[1]
    mycsv = csv.reader(open('resources/index.csv'), delimiter=';')
